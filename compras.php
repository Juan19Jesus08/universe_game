	...
	<div id='wrapper'>
       ...
       <section>
		<div id="consolas" >
			...
			$inf=$web->sqlArray("select * from videojuegos where idCompaniaConsola=1 and idCategoriaVideojuego=1	");
			...
			$inf=$web->sqlArray("select * from videojuegos where idCompaniaConsola=2 and idCategoriaVideojuego=2	");
			...
			$inf=$web->sqlArray("select * from videojuegos where idCompaniaConsola=3 and idCategoriaVideojuego=3	");
			...
			$inf=$web->sqlArray("select * from videojuegos where idCompaniaConsola=4 and idCategoriaVideojuego=4	");
			...
			$inf=$web->sqlArray("select * from videojuegos where idCompaniaConsola=5 and idCategoriaVideojuego=5	");
			...
			$inf=$web->sqlArray("select * from videojuegos where idCompaniaConsola=6 and idCategoriaVideojuego=6	");
			...
			$inf=$web->sqlArray("select * from videojuegos where idCompaniaConsola=6 and idCategoriaVideojuego=7	");
